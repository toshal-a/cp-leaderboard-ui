  ...
  return (
    ...
    >
        ...
        >
          ...
          <Grid item>
            <Typography
              ...
              align="center"
            >
              {moment.unix(contest.startTimeSeconds).format("DD-MM-YYYY HH:mm")}
            </Typography>
            <Typography
              variant="body2"
              color="textSecondary"
      ...
      >
        ...
        <Box flexGrow={1} />
        <Button  onClick={handleContestClick} variant="outlined" color="default" disabled={(contest.phase === 'CODING' || contest.phase ==='FINISHED') ? false: true}>
          Standings
          </Button>
      </Box>
      </Box>
